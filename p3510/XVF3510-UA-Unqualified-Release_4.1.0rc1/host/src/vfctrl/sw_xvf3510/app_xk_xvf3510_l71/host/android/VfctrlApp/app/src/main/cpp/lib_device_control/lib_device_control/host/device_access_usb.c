...
Java_com_xmos_XVF3510_connect(JNIEnv *env, jobject obj,
                                  jint fd, jlongArray handle)
{
  ...
  __android_log_print(ANDROID_LOG_INFO, TAG,
                      "connect completed, devh: 0x%08x\n", devh);
  return ret;
}
/*
JNIEXPORT void JNICALL
Java_com_example_vfctrl_MainActivity_disconnect(JNIEnv *env, jobject obj,
                                                 jlong handle)
{

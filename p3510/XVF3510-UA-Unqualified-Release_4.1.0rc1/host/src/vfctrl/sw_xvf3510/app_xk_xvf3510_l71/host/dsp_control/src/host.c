    ...
    if(current.rw == WRITE) //read the values that the host wants to write
    {
        for(uint32_t i=0; i<num_values; i++)
        {
            switch (current.type) {
                ...
                case TYPE_FIXED_7_24:
                    sscanf(val_1[i], "%8f", &(f));
                    vals[i].f7_24 = (uint32_t)(f * (SCALE_Q(24)));
                    break;
                case TYPE_FIXED_8_24:
                    sscanf(val_1[i], "%8f", &(f));
...
void populate_cmd_table()
{
    if(cmdspec_ap == NULL)
    {
        cmdspec_t cmdspec_ap_local[] = {
            ...
            cmd_con(AP_STAGE_C_RESID, "GET_GAIN_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN, READ, 1, "get gain for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_GAIN_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN, READ, 1, "get gain for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "GET_MAX_GAIN_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_MAX_GAIN, READ, 1, "get max gain for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_MAX_GAIN_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_MAX_GAIN, READ, 1, "get max gain for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "GET_UPPER_THRESHOLD_CH0_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_GET_AGC_DESIRED_UPPER_THRESHOLD, READ, 1, "get upper threshold of desired level for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_UPPER_THRESHOLD_CH1_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_GET_AGC_DESIRED_UPPER_THRESHOLD, READ, 1, "get upper threshold of desired level for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "GET_LOWER_THRESHOLD_CH0_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_GET_AGC_DESIRED_LOWER_THRESHOLD, READ, 1, "get lower threshold of desired level for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_LOWER_THRESHOLD_CH1_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_GET_AGC_DESIRED_LOWER_THRESHOLD, READ, 1, "get lower threshold of desired level for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "GET_ADAPT_CH0_AGC", TYPE_UINT32, AP_STAGE_C_CMD_GET_AGC_ADAPT, READ, 1, "get AGC adapatation for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_ADAPT_CH1_AGC", TYPE_UINT32, AP_STAGE_C_CMD_GET_AGC_ADAPT, READ, 1, "get AGC adapatation for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "GET_LC_ENABLED_CH0_AGC", TYPE_UINT32, AP_STAGE_C_CMD_GET_AGC_LC_ENABLED, READ, 1, "get loss control enable for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "GET_LC_ENABLED_CH1_AGC", TYPE_UINT32, AP_STAGE_C_CMD_GET_AGC_LC_ENABLED, READ, 1, "get loss control enable for channel 1"),

            cmd_con(AP_STAGE_C_RESID, "GET_INCREMENT_GAIN_STEPSIZE_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN_INCREMENT_STEPSIZE, READ, 1, "get stepsize with which gain is incremented for AGC ch0"),
            cmd_con(AP_STAGE_C_RESID, "GET_INCREMENT_GAIN_STEPSIZE_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN_INCREMENT_STEPSIZE, READ, 1, "get stepsize with which gain is incremented for AGC ch1"),
            cmd_con(AP_STAGE_C_RESID, "GET_DECREMENT_GAIN_STEPSIZE_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN_DECREMENT_STEPSIZE, READ, 1, "get stepsize with which gain is decremented for AGC ch0"),
            cmd_con(AP_STAGE_C_RESID, "GET_DECREMENT_GAIN_STEPSIZE_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_GET_AGC_GAIN_DECREMENT_STEPSIZE, READ, 1, "get stepsize with which gain is decremented for AGC ch1"),
            cmd_con(AP_STAGE_C_RESID, "GET_ASR_ALL_CHANNELS", TYPE_INT32, AP_STAGE_C_CMD_GET_ASR_ALL_CHANNELS, READ, 1, "stage C: get asr all channels" ),
            cmd_con(AP_STAGE_C_RESID, "GET_REF_OUT_CH1", TYPE_INT32, AP_STAGE_C_CMD_GET_REF_OUT, READ, 1, "stage C: check if reference audio is output in channel 1"),
            ...
            cmd_con(AP_STAGE_C_RESID, "SET_GAIN_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN, WRITE, 1, "set gain for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_GAIN_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN, WRITE, 1, "set gain for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_MAX_GAIN_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_MAX_GAIN, WRITE, 1, "set gain for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_MAX_GAIN_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_MAX_GAIN, WRITE, 1, "set gain for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_UPPER_THRESHOLD_CH0_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_SET_AGC_DESIRED_UPPER_THRESHOLD, WRITE, 1, "set upper threshold of desired level for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_UPPER_THRESHOLD_CH1_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_SET_AGC_DESIRED_UPPER_THRESHOLD, WRITE, 1, "set upper threshold of desired level for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_LOWER_THRESHOLD_CH0_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_SET_AGC_DESIRED_LOWER_THRESHOLD, WRITE, 1, "set lower threshold of desired level for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_LOWER_THRESHOLD_CH1_AGC", TYPE_FIXED_1_31, AP_STAGE_C_CMD_SET_AGC_DESIRED_LOWER_THRESHOLD, WRITE, 1, "set lower threshold of desired level for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_ADAPT_CH0_AGC", TYPE_UINT32, AP_STAGE_C_CMD_SET_AGC_ADAPT, WRITE, 1, "set gain adaptation for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_ADAPT_CH1_AGC", TYPE_UINT32, AP_STAGE_C_CMD_SET_AGC_ADAPT, WRITE, 1, "set gain adaptation for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_LC_ENABLED_CH0_AGC", TYPE_UINT32, AP_STAGE_C_CMD_SET_AGC_LC_ENABLED, WRITE, 1, "enable loss control for channel 0"),
            cmd_con(AP_STAGE_C_RESID, "SET_LC_ENABLED_CH1_AGC", TYPE_UINT32, AP_STAGE_C_CMD_SET_AGC_LC_ENABLED, WRITE, 1, "enable loss control for channel 1"),
            cmd_con(AP_STAGE_C_RESID, "SET_INCREMENT_GAIN_STEPSIZE_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN_INCREMENT_STEPSIZE, WRITE, 1, "set stepsize with which gain is incremented for AGC ch0"),
            cmd_con(AP_STAGE_C_RESID, "SET_INCREMENT_GAIN_STEPSIZE_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN_INCREMENT_STEPSIZE, WRITE, 1, "set stepsize with which gain is incremented for AGC ch1"),
            cmd_con(AP_STAGE_C_RESID, "SET_DECREMENT_GAIN_STEPSIZE_CH0_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN_DECREMENT_STEPSIZE, WRITE, 1, "set stepsize with which gain is decremented for AGC ch0"),
            cmd_con(AP_STAGE_C_RESID, "SET_DECREMENT_GAIN_STEPSIZE_CH1_AGC", TYPE_FIXED_16_16, AP_STAGE_C_CMD_SET_AGC_GAIN_DECREMENT_STEPSIZE, WRITE, 1, "set stepsize with which gain is decremented for AGC ch1"),
            cmd_con(AP_STAGE_C_RESID, "SET_ASR_ALL_CHANNELS", TYPE_INT32, AP_STAGE_C_CMD_SET_ASR_ALL_CHANNELS, WRITE, 1, "stage C: set asr all channels"),
            cmd_con(AP_STAGE_C_RESID, "SET_REF_OUT_CH1", TYPE_INT32, AP_STAGE_C_CMD_SET_REF_OUT, WRITE, 1, "stage C: set reference audio on channel 1"),

...
cd ../host/Win32/bin
dfu_suffix_generator.exe 0x20B1 0x0014 ../../../bin/app_xvf3510_ua_xe_to_dfu_uprade_v410.bin boot.dfu
dfu_suffix_generator.exe 0x20B1 0x0014 ../../../data-partition/output/data_partition_upgrade_user_define_xvf3510_v4_1_0.bin data_user_define_dfu_update.dfu
dfu_usb.exe --vendor-id 0x20B1 --product-id 0x0014 write_upgrade boot.dfu data_user_define_dfu_update.dfu
pause
